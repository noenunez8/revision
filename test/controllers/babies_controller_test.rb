...
class BabiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create baby" do
    assert_difference('Baby.count') do
      post babies_url, params: { baby: { date_of_birth: @baby.date_of_birth, first_name: @baby.first_name, last_name: @baby.last_name, weight: @baby.weight } }
    end
  ...
  test "should update baby" do
    patch baby_url(@baby), params: { baby: { date_of_birth: @baby.date_of_birth, first_name: @baby.first_name, last_name: @baby.last_name, weight: @baby.weight } }
